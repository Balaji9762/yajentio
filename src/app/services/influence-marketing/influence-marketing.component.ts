...
@Component({
  selector: 'app-influence-marketing',
  standalone: false,
  templateUrl: './influence-marketing.component.html',
  styleUrl: './influence-marketing.component.scss'
})
export class InfluenceMarketingComponent {
seoSteps = [
    {
      iconUrl: 'assets/images/services/seo/i 2.png',
      title: 'Amplify Your Brand with Powerful Influencer Partnerships',
      description: 'Yajentio Training Academy connects your brand with authentic influencers to boost visibility, build trust, and drive real engagement across platforms like Instagram and YouTube.'
    },
    {
      iconUrl: 'assets/images/services/seo/i 3.png',
      title: 'What is Influence Marketing?',
      description: 'Influencer marketing connects your brand with trusted voices to create authentic content that drives engagement and builds credibility. At Yajentio Training Academy, we pair you with the right creators to deliver real impact, not just impressions.'
    }
  ];
  // Array of benefit objects
  benefits = [
    {
      iconUrl: 'assets/images/services/seo/b1.png',
      title: 'Influencer Discovery & Selection',
      description: 'At Yajentio Training Academy, we match your brand with influencers who truly align with your niche — from emerging creators to well-known personalities across fashion, tech, food, fitness, and beyond — to deliver authentic content and meaningful reach.'
    },
    {
      iconUrl: 'assets/images/services/seo/b2.png',
      title: 'Campaign Strategy & Execution',
      description: 'We design tailored influencer campaigns that reflect your brand’s personality and objectives. From concept to coordination, our team handles everything — ensuring a seamless, impactful launch.'
    },
    {
      iconUrl: 'assets/images/services/seo/b3.png',
      title: 'Content Creation & Collaborations',
      description: 'We create engaging influencer content — from reels and videos to unboxings and testimonials — that captures attention, tells your story, and sparks real audience interaction.'
    },
    {
      iconUrl: 'assets/images/services/seo/b4.png',
      title: 'Paid Partnerships & Sponsorships',
      description: 'Elevate your brand’s trust and reach with strategic influencer partnerships. At Yajentio Training Academy, we ensure every sponsored collaboration is optimized for engagement, visibility, and measurable returns.'
    },
    {
      iconUrl: 'assets/images/services/seo/b5.png',
      title: 'Influencer Relationship Management',
      description: 'From negotiating deals to building lasting influencer relationships, we manage it all — ensuring consistent collaboration and alignment with your brand’s vision.'
    },
    {
      iconUrl: 'assets/images/services/seo/metrics.png',
      title: 'Performance Tracking & Analytics',
      description: 'Measure what matters. We deliver clear, actionable insights on reach, engagement, conversions, and ROI — helping you refine and scale your influencer campaigns with confidence.'
    }
  ];
