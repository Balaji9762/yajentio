...
@Component({
  selector: 'app-content-writing',
  standalone: false,
  templateUrl: './content-writing.component.html',
  styleUrl: './content-writing.component.scss'
})
export class ContentWritingComponent {
seoSteps = [
    {
      iconUrl: 'assets/images/services/seo/seo-1.png',
      title: 'Research and Planning',
      description: 'At Yajentio Training Academy, we begin with smart research — diving into your industry and audience to craft content that speaks clearly, connects deeply, and drives results.'
    },
    {
      iconUrl: 'assets/images/services/seo/content-1.png',
      title: 'Crafting Compelling Content',
      description: 'We create SEO-friendly blogs and web content that engage readers, boost visibility, and align with your brand’s digital goals'
    },
    {
      iconUrl: 'assets/images/services/seo/target-1.png',
  ...
  benefits = [
    ...
    },
    {
      ...
      title: 'Long-Term Marketing Value',
      description: 'Great content keeps working for you — attracting traffic, generating leads, and engaging audiences long after it goes live.'
    },
    {
    ...
    },
    {
      ...
      description: 'We craft content that sparks conversation — driving shares, comments, and engagement to expand your brand’s reach across all digital channels.'
    },
    {
    ...
    },
    {
      ...
      description: 'At Yajentio Training Academy, we create content tailored to your audience’s needs and interests — delivering the right message to the right people, exactly when it matters most.'
    }
  ];
